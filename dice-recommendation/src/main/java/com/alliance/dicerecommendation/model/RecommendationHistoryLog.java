...
@Data
@Table("EVT_RECOMMENDATION_HISTORY_LOG")
public class RecommendationHistoryLog extends BaseInfo {
    @PrimaryKeyColumn(name = "RECOMMENDATION_HISTORY_LOG_ID", ordinal = 0, type = PrimaryKeyType.PARTITIONED, ordering = Ordering.ASCENDING)
    @CassandraType(type = CassandraType.Name.UUID)
    private UUID recommendationHistoryLogId = Uuids.timeBased();
